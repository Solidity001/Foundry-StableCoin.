 ...
 * @title DSCEngine
 * @author StarLaw
 * The system is designed to be as minimal as possible, and have the tokens maintain a peg 1 token == $1 peg.
 * This stable coin has the properties:
 * - Exogenous Collateral (BTC, ETH)
 * - Dollar Pegged
 * - Algorithmic Stable
 * It is similar to DAI if DAI had no governance, no fees, and was only backed by WETH and WBTC.
 *
 * @notice This contract is the core of the DSC System. It handles all the logic for mining and redeeming DSC, as well as depositing & withdrawing collateral.
 * Our  DSC system should be always be "overcollateralized". At no point, should the value of all collateral <= the $ backed value of all the DSC.
...
contract DSCEngine is ReentrancyGuard {
    ...
    function mintDsc(uint256 amountDscToMint) public moreThanZero(amountDscToMint) nonReentrant {
        ...
        // if they minted too much DSC compared to their collateral
        _revertIfHealthFactorIsBroken(msg.sender);
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); // anapa mbutai shtezo
    }
